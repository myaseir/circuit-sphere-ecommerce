    ...
    <div className="group">
      <div className="relative overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        <div className="text-center px-4 py-7.5">
          {/* Reviews - Keeping static for now, or use item.reviews if available */}
          ...
          {/* ✅ FIXED: Dynamic Link to Product Details */}
        ...
        {/* ✅ FIXED: Correct Image Path for API Data */}
        <div className="flex justify-center items-center">
          <Image 
            src={item.image && item.image[0] ? item.image[0] : "/images/product/product-01.png"} 
            alt={item.title} 
            width={280} 
            height={280}
            className="object-contain h-[280px]" // Ensures images don't stretch
          />
        </div>
