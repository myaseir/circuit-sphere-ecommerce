        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="max-w-[330px] w-full">
            <Link href="/" className="inline-block mb-8">
               <h2 className="text-2xl font-bold text-dark">Circuit<span className="text-blue">Sphere</span></h2>
            </Link>
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex gap-4.5">
                ...
                <span className="text-gray-600">
                  Office 104, IT Park, Islamabad,<br/> Pakistan.
                </span>
              </li>

              {/* PHONE */}
              <li>
                <a href="tel:+923001234567" className="flex items-center gap-4.5 group">
              ...
              {/* EMAIL */}
              <li>
                <a href="mailto:sales@circuitsphere.pk" className="flex items-center gap-4.5 group">
                  <span className="flex-shrink-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5 text-gray-600">
              <li><Link href="/shop/arduino" className="hover:text-blue transition-colors">Arduino Boards</Link></li>
              <li><Link href="/shop/esp32" className="hover:text-blue transition-colors">ESP32 & IoT</Link></li>
              <li><Link href="/shop/sensors" className="hover:text-blue transition-colors">Sensors</Link></li>
              <li><Link href="/shop/robotics" className="hover:text-blue transition-colors">Robotics Kits</Link></li>
              <li><Link href="/shop/tools" className="hover:text-blue transition-colors">Tools & Soldering</Link></li>
            </ul>
          </div>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3 text-gray-600">
              <li><Link href="/track-order" className="hover:text-blue transition-colors">Track Your Order</Link></li>
              <li><Link href="/shipping" className="hover:text-blue transition-colors">Shipping (TCS/Leopard)</Link></li>
              <li><Link href="/returns" className="hover:text-blue transition-colors">Returns & Refund</Link></li>
              <li><Link href="/contact" className="hover:text-blue transition-colors">Contact Support</Link></li>
              <li><Link href="/fyp" className="hover:text-blue transition-colors">FYP Guidance</Link></li>
            </ul>
          </div>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-gray-500 font-medium text-sm">
              &copy; {year} Circuit Sphere. All rights reserved. | <span className="text-blue">Designed in Pakistan 🇵🇰</span>
            </p>
