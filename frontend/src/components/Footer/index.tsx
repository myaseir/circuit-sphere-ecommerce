        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          ...
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-4">
              ...
              {/* EMAIL */}
              <li>
                <a href="mailto:glacialabs@gmail.com" className="flex items-center gap-4.5 group">
                  <span className="flex-shrink-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-4 mt-7.5">
              ...
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="flex ease-out duration-200 hover:text-blue text-gray-400">
                <svg className="fill-current" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <path d="M15.2188 5.96875C15.8573 5.96875 16.375 5.45106 16.375 4.8125C16.375 4.17391 15.8573 3.65625 15.2188 3.65625C14.5802 3.65625 14.0625 4.17391 14.0625 4.8125C14.0625 5.45106 14.5802 5.96875 15.2188 5.96875Z" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5 text-gray-600">
              <li><Link href="/shop-with-sidebar" className="hover:text-blue transition-colors">Arduino Boards</Link></li>
              <li><Link href="/shop-with-sidebar" className="hover:text-blue transition-colors">ESP32 & IoT</Link></li>
              <li><Link href="/shop-with-sidebar" className="hover:text-blue transition-colors">Sensors</Link></li>
              <li><Link href="/shop-with-sidebar" className="hover:text-blue transition-colors">Robotics Kits</Link></li>
              <li><Link href="/shop-with-sidebar" className="hover:text-blue transition-colors">Tools & Soldering</Link></li>
            </ul>
          </div>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3 text-gray-600">
              ...
              <li><Link href="/error" className="hover:text-blue transition-colors">FYP Guidance</Link></li>
            </ul>
          </div>
