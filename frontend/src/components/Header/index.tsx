...
const Header = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState("0"); // <--- 2. New State for Category
  ...
  // <--- 4. Search Logic Function
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault();
    const query = searchQuery.trim();
    
    // Check if user typed something OR selected a category other than "All"
    if (query || selectedCategory !== "0") {
      // Redirect to Shop page with parameters
      // Example result: /shop?search=arduino&category=1
  ...
  const options = [
    ...
    { label: "Microcontrollers & Development Boards", value: "1" },
    { label: "Robotics & Mechanical Actuators", value: "2" },
    { label: "Solar Electronics & DC Protection", value: "3" },
    { label: "Computer Storage & Speed Upgrades", value: "4" },
    { label: "IoT Sensors & Environmental Modules", value: "5" },
    { label: "Smart Home Automation", value: "6" },
    { label: "Batteries & Power Management (BMS)", value: "7" },
    { label: "Wireless Communication Modules", value: "8" },
    { label: "Displays & Human Interface", value: "9" },
    { label: "Prototyping Tools & Consumables", value: "10" },
  ];
            ...
            <div className="max-w-[475px] w-full">
              ...
              <form onSubmit={handleSearch}>
                <div className="flex items-center">
                  ...
                  {/* <--- 6. Pass onChange to CustomSelect --> */}
                  <CustomSelect 
                    options={options} 
