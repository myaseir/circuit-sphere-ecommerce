...
const ShopWithoutSidebar = () => {
  ...
  const limit = 12; // Show more items since there is no sidebar
...
// ✅ Fetch Data from API
  ...
  return (
    <>
      <Breadcrumb
        title={"Laptops"} // Updated Title
        pages={["shop", "/", "Laptops"]} // Updated Breadcrumb
      />
