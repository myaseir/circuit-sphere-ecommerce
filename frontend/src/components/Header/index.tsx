...
// ✅ MENU DATA: Categories is now a direct link (No Dropdown)
const menuData = [
  {
    id: 1,
    title: "Home",
  ...
  },
  {
    id: 3,
    title: "Categories", 
    path: "/categories", // ✅ DIRECT LINK to your new grid page
    newTab: false,
    submenu: null,       // ✅ REMOVED DROPDOWN
  },
  {
    id: 4,
    title: "Tutorial", 
    path: "/blog", // ✅ DIRECT LINK to your new grid page
    newTab: false,
    submenu: null,       // ✅ REMOVED DROPDOWN
  },
  {
...
const Header = () => {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    if (query || selectedCategory !== "0") {
      router.push(`/shop?search=${encodeURIComponent(query)}&category=${selectedCategory}`);
    }
  };
  ...
  const options = [
    ...
    { label: "Solar & Power", value: "3" },
    { label: "Computer Parts", value: "4" },
    { label: "IoT Sensors", value: "5" },
    { label: "Smart Home", value: "6" },
    { label: "Batteries", value: "7" },
    { label: "Wireless", value: "8" },
    { label: "Displays", value: "9" },
    { label: "Prototyping", value: "10" },
  ];
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link href="/">
                <Image
                    ...
                    alt="Glacia Labs - Electronics Store Pakistan"
                    width={219}
                    height={36}
                    priority 
                />
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-[5px] bg-gray-1 !border-l-0 border border-gray-3 py-2.5 pl-4 pr-10 outline-none ease-in duration-200 focus:border-blue-500"
                    />
            ...
            <div className="hidden xl:flex items-center gap-3.5">
              <div className="flex items-center gap-2">
                 ...
                 <div>
                   ...
                   <p className="font-medium text-custom-sm text-dark">(+92) 316-9030178</p>
                 </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-5">
                ...
                <button onClick={handleOpenCartModal} className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-custom-sm text-dark">PKR {totalPrice.toLocaleString()}</p>
                  </div>
                </button>
              </div>
