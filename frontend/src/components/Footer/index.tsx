...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-white border-t border-gray-200">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        
        {/* */}
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          
          {/* COLUMN 1: CONTACT INFO (Local SEO) */}
          <div className="max-w-[330px] w-full">
            <Link href="/" className="inline-block mb-8">
               <h2 className="text-2xl font-bold text-dark">Glacia<span className="text-blue">Labs</span></h2>
            </Link>
            ...
            <div className="flex items-center gap-4 mt-7.5">
              {/* Facebook */}
              <a href="#" aria-label="Facebook" className="flex ease-out duration-200 hover:text-blue text-gray-400">
            ...
            {/* Instagram */}
<a href="https://www.instagram.com/glacialabs/" aria-label="Instagram" className="flex ease-out duration-200 hover:text-blue text-gray-400">
  <svg 
    width="20" 
    height="20" 
    viewBox="0 0 24 24" 
  ...
  >
    ...
    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
          ...
          {/* COLUMN 2: CATEGORIES (Changed from "Account" for SEO) */}
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-lg font-medium text-dark">
              Top Categories
            </h2>

            <ul className="flex flex-col gap-3.5 text-gray-600">
              <li><Link href="/shop?category=microcontrollers-development-boards" className="hover:text-blue transition-colors">Arduino Boards</Link></li>
              <li><Link href="/shop?category=microcontrollers-development-boards" className="hover:text-blue transition-colors">ESP32 & IoT</Link></li>
              <li><Link href="/shop?category=iot-sensors-environmental-modules" className="hover:text-blue transition-colors">Sensors</Link></li>
              <li><Link href="/shop?category=robotics-mechanical-actuators" className="hover:text-blue transition-colors">Robotics Kits</Link></li>
              <li><Link href="/shop?category=batteries-power-management-bms" className="hover:text-blue transition-colors">Batteries and Power Management</Link></li>
            </ul>
          </div>

          {/* COLUMN 3: CUSTOMER CARE (Changed from "Quick Link") */}
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-lg font-medium text-dark">
              Customer Care
            </h2>
            ...
            <ul className="flex flex-col gap-3 text-gray-600">
              <li><Link href="/error" className="hover:text-blue transition-colors">Track Your Order</Link></li>
              <li><Link href="/error" className="hover:text-blue transition-colors">Shipping (TCS/Leopard)</Link></li>
              <li><Link href="/return-policy" className="hover:text-blue transition-colors">Returns & Refund</Link></li>
              <li><Link href="/contact" className="hover:text-blue transition-colors">Contact Support</Link></li>
              <li><Link href="/blog" className="hover:text-blue transition-colors">FYP Guidance</Link></li>
            </ul>
          </div>

          {/* COLUMN 4: DOWNLOAD APP (Kept visual structure) */}
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-lg font-medium text-dark lg:text-right">
              Get the App
            </h2>
            <p className="lg:text-right text-sm text-gray-500 mb-4">
              Shop faster with our mobile app.
            </p>

            <ul className="flex flex-col lg:items-end gap-3">
              <li>
                <a className="inline-flex items-center gap-3 py-[9px] pl-4 pr-7.5 text-white rounded-md bg-dark ease-out duration-200 hover:bg-opacity-95" href="#">
                  <svg className="fill-current" width="24" height="24" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a className="inline-flex items-center gap-3 py-[9px] pl-4 pr-8.5 text-white rounded-md bg-blue ease-out duration-200 hover:bg-opacity-95" href="#">
                  <svg className="fill-current" width="24" height="24" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <span className="block text-[10px]">Get in On</span>
      ...
      {/* */}
      <div className="py-5 xl:py-7.5 bg-gray-50 border-t border-gray-200">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-gray-500 font-medium text-sm">
              &copy; {year} Glacia Labs. All rights reserved. | <span className="text-blue">Designed in Pakistan 🇵🇰</span>
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <span className="font-medium text-sm text-gray-500">We Accept:</span>
              <div className="flex flex-wrap items-center gap-4 opacity-70 grayscale hover:grayscale-0 transition-all">
                <Image src="/images/payment/payment-01.svg" alt="visa" width={50} height={20} />
                <Image src="/images/payment/payment-03.svg" alt="mastercard" width={30} height={20} />
                {/* You can add JazzCash / EasyPaisa logos here later */}
              </div>
            </div>
          </div>
        </div>
